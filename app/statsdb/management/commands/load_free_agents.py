...
class Command(BaseCommand):
    ...
    def parse_new_players(self):
        ...
        with open("data/rosters/free_agents.json", "r") as readfile:
        ...
        for player in players:
            ...
            elif player.get("playerid1", None):
    ...
    def get_new_players(self):
        ...
        with open(f"data/rosters/free_agents.json", "r") as readfile:
            roster = json.loads(readfile.read())
            ...
            for player in roster:
                ...
                for possible_id in ["playerId","playerid1", "oPlayerId", "minormasterid"]:
